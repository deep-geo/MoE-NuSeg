...
class MyDataset(Dataset):
    ...
    def generate_normal_edge_mask(self,label):
        ...
        # unique_values = np.unique(normal_edge_mask)
        # print(unique_values)

        normal_edge_mask[normal_edge_mask == 150] = 2  # Green, normal edge , Grayscale=0.299×Red+0.587×Green+0.114×Blue
        normal_edge_mask[normal_edge_mask == 76] = 2  # Red, Cluster edge 
